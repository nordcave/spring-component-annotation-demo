package nord.springdemo.domain.promotion;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Component;

import nord.springdemo.domain.product.ConsumerProduct;
import nord.springdemo.domain.product.IndustrialProduct;
...
//	}
	...
	public String specialPromotionalPricing() {
		String priceInfo = "Industrial Product is priced at $" + 
							declareIndustrialProductPrice(industrialProduct) + " and " +
